...
import '../styles/SavedImagesPage.css';
import { postTwelveSavedImages } from '../api';
import ImageModal from '../Components/ImageModal';

const SavedImagesPage = (props) => {
  ...
  async function getImages() {
    const imageList = [];
    const twelveImages = await postTwelveSavedImages(props.Email, iterations);
          ...
          <Row className="justify-content-center" md={2}>
            ...
            {allImages && (
              <div class="text-center">
                <p style={{fontSize: "20px" }}>No more saved pictures</p>
              </div>
            )}
          </Row>
          <br />
